...
abstract class Hilt_PhoneCallReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((PhoneCallReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectPhoneCallReceiver(UnsafeCasts.<PhoneCallReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
